...
int main()
{
    ...
    while (t--)
    {
        ...
        ll mid = ceil((db)(n) / 2.0);
        ll median = 0;
        ll s = 3;
        if (a[mid].se == 1 && k > 0)
        {
            print(a[mid].fi + 1 + max1);
            continue;
        }
        if (mid + 1 < n && a[mid + 1].fi == a[mid].fi && a[mid + 1].se == 1 && k > 0)
        {
            print(a[mid].fi + max1 + 1);
            continue;
        }
        if (mid - 1 >= 0 && a[mid - 1].fi == a[mid].fi && a[mid - 1].se == 1 && k > 0)
        {
            print(a[mid].fi + max1 + 1);
            continue;
        }
